...
namespace Spotidie.DAL.EF
{
        ...
        //public class SpotidieContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            var mainuserId = Guid.NewGuid();
            var playlistId1 = Guid.NewGuid();
            ...
            builder.Entity<Playlist>().HasData(
                new Playlist[]
                {
                    new Playlist
                    {
                        PlaylistId = playlistId1, PlaylistName = "This is MORGENSTERN",
                    ...
                    new Playlist
                    {
                        PlaylistId = playlistId2, PlaylistName = "This Is Billie Eilish",
            ...
            builder.Entity<MainUser>().HasData(
                new MainUser[]
                {
                    new MainUser
                    {
                        MainUserId = mainuserId, MainUserEmail = "test5@mail.ru", MainUserPassword = "Qwerty123?",
                        MainUserName = "test1", MainUserIsPremium = true, MainUserIsAdmin = true,
                        MainUserAvatar = "https://i.ytimg.com/vi/3UF96jzrX4o/hqdefault.jpg",MainUserForeignKey = morgenAuthorId
                    },
                });
