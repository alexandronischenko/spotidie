    ...
    //public class SpotidieContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Author>().HasData(
                new Author[]
                {
                    new Author{AuthorId = new Guid(),AuthorName = "Awolnation",AuthorAvatar = "https://miro.medium.com/max/1400/1*NhL0RhtXr4tYhYExPyHW4g.jpeg",},
                    new Author{AuthorId = new Guid(),AuthorName = "Morgenstern",AuthorAvatar = "http://sun9-10.userapi.com/s/v1/if1/CSawlnOoYN9CC6IgDfCSUjqvluyGA9KqvJ8ujexQy5KVmJw5mxnsAxKwBY7o8mazS9svVxf_.jpg?size=604x604&quality=96&type=album"},
                    new Author{AuthorId = new Guid(),AuthorName = "Баста",AuthorAvatar = "https://i.scdn.co/image/ab6761610000e5ebf5c9cb7c03d1e4e5226fc232"},
                    new Author{AuthorId = new Guid(),AuthorName = "Michael Jackson",AuthorAvatar = "https://upload.wikimedia.org/wikipedia/commons/4/40/Michael_Jackson_Dangerous_World_Tour_1993.jpg"},
                    new Author{AuthorId = new Guid(),AuthorName = "Billie Eilish",AuthorAvatar = "https://www.buro247.ua/thumb/670x830_0/images/2020/09/billie-eilish-photos-bodyshaming-01.jpg"},
                });
            ...
            builder.Entity<Track>().HasData(
                new Track[]
                {
                    ...
                    new Track{TrackId = new Guid(),TrackName = "Oxytocin",TrackDuration = 210,TrackData = "https://open.spotify.com/track/0UJAH9v2PmS7sBcuBquprR?si=2fc802a0d83c4470",TrackAvatar = "https://spiritofrock.ru/wp-content/uploads/2021/10/Billie-Eilish-Happier-Than-Ever-Tour-1000x600-1.jpg",},
                    new Track{TrackId = new Guid(),TrackName = "Happier Than Ever",TrackDuration = 298,TrackData = "https://open.spotify.com/track/4RVwu0g32PAqgUiJoXsdF8?si=62abafa4e4da4f89",TrackAvatar = "https://spiritofrock.ru/wp-content/uploads/2021/10/Billie-Eilish-Happier-Than-Ever-Tour-1000x600-1.jpg",},
                    new Track{TrackId = new Guid(),TrackName = "Bored",TrackDuration = 180,TrackData = "https://open.spotify.com/track/04sN26COy28wTXYj3dMoiZ?si=bccdf3f86317456c",TrackAvatar = "https://lastfm.freetls.fastly.net/i/u/ar0/8bccd9c4336ffdbe502671287bc1b85c.jpg",},
                });
            ...
            builder.Entity<Playlist>().HasData(
                new Playlist[]
                {
                    new Playlist{PlaylistId = new Guid(),PlaylistName = "This is MORGENSTERN",PlaylistAvatar = "https://thisis-images.scdn.co/37i9dQZF1DZ06evO0vvwas-large.jpg"},
                    ...
                    new Playlist{PlaylistId = new Guid(),PlaylistName = "This Is Billie Eilish",PlaylistAvatar = "https://i.scdn.co/image/ab67706f000000034d26d431869cabfc53c67d8e"},
                });
            ...
            builder.Entity<MainUser>().HasData(
                new MainUser[]
                {
                    new MainUser{MainUserId = new Guid(),MainUserEmail = "test1@mail.ru",MainUserPassword = "Qwerty123?",MainUserName = "test1",MainUserIsPremium = true,MainUserIsAdmin = true,MainUserAvatar = "https://i.ytimg.com/vi/3UF96jzrX4o/hqdefault.jpg",},
                    new MainUser{MainUserId = new Guid(),MainUserEmail = "test2@mail.ru",MainUserPassword = "Qwerty123?",MainUserName = "test2",MainUserIsPremium = false,MainUserIsAdmin = false,MainUserAvatar = "https://i.mycdn.me/i?r=AyH4iRPQ2q0otWIFepML2LxR0MrEgIyhL-Sk3iEO-sagEQ",},
                    new MainUser{MainUserId = new Guid(),MainUserEmail = "test3@mail.ru",MainUserPassword = "Qwerty123?",MainUserName = "test3",MainUserIsPremium = false,MainUserIsAdmin = false,MainUserAvatar = "https://www.meme-arsenal.com/memes/22a1ada0935edc5a844e4aef793bd20f.jpg"},
                });
            ...
            {
                new MainUser{MainUserId = new Guid(),MainUserEmail = "test4@mail.ru",MainUserPassword = "Qwerty123?",MainUserName = "test1",MainUserIsPremium = true,MainUserIsAdmin = true,MainUserAvatar = "https://i.ytimg.com/vi/3UF96jzrX4o/hqdefault.jpg",
                    Playlists = 
