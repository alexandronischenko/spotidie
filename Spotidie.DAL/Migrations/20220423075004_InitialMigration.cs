        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorAvatar = table.Column<byte[]>(type: "bytea", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MainUserEmail = table.Column<string>(type: "text", nullable: true),
                    MainUserPassword = table.Column<string>(type: "text", nullable: true),
                    MainUserName = table.Column<string>(type: "text", nullable: true),
                    MainUserIsPremium = table.Column<bool>(type: "boolean", nullable: false),
                    MainUserIsAdmin = table.Column<bool>(type: "boolean", nullable: false),
                    MainUserAvatar = table.Column<byte[]>(type: "bytea", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MainUsers", x => x.MainUserId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlaylistAvatar = table.Column<byte[]>(type: "bytea", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrackData = table.Column<byte[]>(type: "bytea", nullable: true),
                    TrackAvatar = table.Column<byte[]>(type: "bytea", nullable: true),
